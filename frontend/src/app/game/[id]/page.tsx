...
export default function GameDescription({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        async function getGameData() {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/game_info.php?id=${id}`, {
                method: 'GET',
            });
    ...
    const startGame = async () => {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/game_session.php`, {
            method: 'POST',
